...
#define TYPE_RANGE SCHAR_MAX
#if TYPE_RANGE == 127
#define SCHAR_BIT 8
#elif TYPE_RANGE == 32767
#define SCHAR_BIT 16
#elif TYPE_RANGE == 2147483647
#define SCHAR_BIT 32
#elif TYPE_RANGE == 9223372036854775807
#define SCHAR_BIT 64
#elif TYPE_RANGE == 340282366920938463463374607431768211455
#define SCHAR_BIT 128
#endif
#undef TYPE_RANGE
#define SIZEOF_SCHAR (SCHAR_BIT/CHAR_BIT)

#define TYPE_RANGE SHRT_MAX
#if TYPE_RANGE == 32767
#define SHRT_BIT 16
#elif TYPE_RANGE == 2147483647
#define SHRT_BIT 32
...
#elif TYPE_RANGE == 9223372036854775807
#define INT_BIT 64
#elif TYPE_RANGE - INT_MIN == 340282366920938463463374607431768211455
#define INT_BIT 128
#endif
#undef TYPE_RANGE
#define SIZEOF_INT (INT_BIT/CHAR_BIT)

#define TYPE_RANGE LONG_MAX
#if TYPE_RANGE == 2147483647
#define LONG_BIT 32
#elif TYPE_RANGE == 9223372036854775807
#define LONG_BIT 64
#elif TYPE_RANGE == 340282366920938463463374607431768211455
...
#define TYPE_RANGE LLONG_MAX
#if TYPE_RANGE == 9223372036854775807
#define LLONG_BIT 64
#elif TYPE_RANGE == 340282366920938463463374607431768211455
